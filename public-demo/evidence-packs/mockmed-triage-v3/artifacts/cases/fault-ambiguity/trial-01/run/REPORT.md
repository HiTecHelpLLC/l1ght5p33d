...
- **Started:** 2026-07-26T07:07:05.070942+00:00
...
- **Governed authorization:** `83809581eeb247aaae7bf7ca8a6e9e00` (public-demo-qualified-campaign)
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 1 | `step_000` | click 'Open' | &mdash; | &mdash; | &mdash; | 153 |  | ❌ |
...
> ❌ **Error:** Structural safety refusal for step 'step_000' (click 'Open'): DOM locator is ambiguous: candidate_count=2 — no action was admitted

**Rung** &mdash; (keyboard / wait step, no anchor) · **Gates** none on this step · **Heal** none · **Outcome** ❌ HALTED (governed refusal)
