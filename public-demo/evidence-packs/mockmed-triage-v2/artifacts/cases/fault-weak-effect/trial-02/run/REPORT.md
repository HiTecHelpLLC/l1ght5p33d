...
- **Started:** 2026-07-25T19:28:08.642751+00:00
...
- **Governed authorization:** `499e8f0b2057411a8e5d6f53e25cd30d` (public-demo-qualified-campaign)
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 1 | `step_000` | click 'Open' | structural | 1.00 | id ✓ | 712 |  | ✅ |
| 2 | `step_001` | click 'New Encounter' | structural | 1.00 | id ✓ | 933 |  | ✅ |
| 3 | `step_002` | click 'Triage' | structural | 1.00 | id ✓ | 397 |  | ✅ |
| 4 | `step_003` | click at (480, 268) | structural | 1.00 | id ✓ | 378 |  | ✅ |
| 5 | `step_004` | type <note> | &mdash; | &mdash; | input ✓ | 487 |  | ✅ |
| 6 | `step_005` | click 'Save Encounter' | structural | 1.00 | id ✓, effect ✗ | 6022 |  | ❌ |
