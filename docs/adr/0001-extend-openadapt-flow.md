...
[technical spikes](../l1ght5p33d/technical-spikes.md).
...
L1ght5p33d is a history-preserving downstream fork from upstream commit
...
The new separately packaged `l1ght5p33d` namespace adds a restricted provider
...
validated with Pydantic and a versioned L1ght5p33d envelope. This is a material
...
- The official MCP Python SDK handles protocol transport. L1ght5p33d supplies
...
material is included in L1ght5p33d's wheel or sdist. OculiX, OpenRPA, the broad
...
capabilities and must not be confused with L1ght5p33d's narrower permission
surface. Only the creator package and declared examples are covered by the
L1ght5p33d v0.1.0 acceptance matrix. Upstream production-admission claims are
