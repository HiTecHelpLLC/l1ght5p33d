...
from createrelay.providers.vision import (
    VisualSelectorError,
    match_template,
    match_text,
    template_path,
)
from createrelay.providers.windows import WindowIdentity, WindowsProvider
...
def test_generated_windows_workflow_validates() -> None:
    from createrelay.fixtures.windows_demo import fixture_workflow
