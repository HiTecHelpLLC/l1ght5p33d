"""Opt-in real WinForms/UIA test. Set L1GHT5P33D_WINDOWS_LIVE=1 on Windows.
...
@pytest.mark.skipif(
    sys.platform != "win32" or os.environ.get("L1GHT5P33D_WINDOWS_LIVE") != "1",
        ...
        while True:
            try:
                ...
                try:
                    ...
                    if os.environ.get("L1GHT5P33D_ALLOW_NO_FOREGROUND") == "1":
                        pytest.skip(
